...
# Pairwise comparison between AIS and MIM (SomaScan Proteomics)
...
#plot(Boruta.IS.MIM.all, las=2, cex.axis=0.7, xlab="", main="Variable Importance")
#plotImpHistory(Boruta.IS.MIM.all)
...
plotPercentBars( vp[1:10,]) + ggtitle( "Variance fractions of first 10 proteins between AIS and MIM")
...
#Top Proteins identified in at least 2 of the 3 protein selection approaches (AIS vs. MIM)
