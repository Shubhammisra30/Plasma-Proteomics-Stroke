...
# Pairwise comparison between AIS and TIA (BAK270 Proteomics, Internal Validation)
...
plotPercentBars( vp[1:5,]) + ggtitle( "Top 5 Proteins associated with Outcome (IS vs. TIA)" )