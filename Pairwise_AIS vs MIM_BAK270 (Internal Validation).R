...
# Pairwise comparison between AIS and MIM (BAK270 Proteomics, Internal Validation)
...
plot.Boruta.sel(Boruta.IS.MIM.all, cex.axis= 0.5, las= 2, xlab= "",
                pars = c("IGFBP2", "APCS",  "CAMP", "CNDP1",  "CST3", "F2", "APOL1",  "TNXB", "F11",  "B2M",  "APOM", "APOA1",  "ANG"));
...
plotPercentBars( vp[1:5,]) + ggtitle( "Top 5 Proteins associated with Outcome (AIS vs. MIM)" )