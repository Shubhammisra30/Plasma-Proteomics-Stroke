...
# Pairwise comparison between AIS and ICH (BAK-270 Proteomics, Internal Validation)
...
plot.Boruta.sel(Boruta.IS.ICH.all, cex.axis= 0.5, las= 2, xlab= "",
                pars = c("MGP", "SERPIND1", "C1RL", "F11", "THBS1", "APOC3"));
...
plotPercentBars( vp[1:5,]) + ggtitle( "Top 5 Proteins associated with Outcome (AIS vs. ICH)" )