...
# Pairwise comparisons between ICH and TIA (BAK270 Proteomics, Internal Validation)
...
plot.Boruta.sel(Boruta.ICH.TIA.all, cex.axis= 0.5, las= 2, xlab= "",
                pars = c("CRTAC1", "AZGP1", "C1RL", "PARK7"));
...
plotPercentBars( vp[1:5,]) + ggtitle( "Top 5 Proteins associated with Outcome (ICH vs. TIA)" )