...
# Pairwise comparison between ICH and MIM (BAK270 Proteomics, Internal Validation)
...
plot.Boruta.sel(Boruta.ICH.MIM.all, cex.axis= 0.5, las= 2, xlab= "",
                pars = c("VTN", "SERPINA10", "PLG", "SERPIND1", "FBLN1",  "CST3", "C1RL", "CP", "B2M", "PROC"));
...
plotPercentBars( vp[1:5,]) + ggtitle( "Top 5 Proteins associated with Outcome (ICH vs. MIM)" )